...
while [ "$(date +%s)" -lt "$END_TS" ]; do
  ...
  # Срабатывает только если экран ЗАМРОЖЕН (модель не печатает) И маркер-строка «Thought»
  # (в новых версиях TUI буллет «•» убран — строка просто «  Thought»; буллет опционален),
