...
| main-house | Запуск окружения MAIN-HOUSE (tmux-сессия с окнами control-center/work): Ctrl+C → перезапуск enterwatch+tail, создание окон при отсутствии сессии. Выполнить в начале каждого запуска |
